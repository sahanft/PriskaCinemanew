...
public class TicketDaoImpl {
    ...
    public static boolean save(ManageTicketDto dto) throws SQLException, ClassNotFoundException {
    ...
    public static List<ManageTicketDto> loadAll() throws SQLException {
   ...
   /* public static ArrayList<ManageTicketDto> getAllseat() throws SQLException {
    ...
    public static boolean update(ManageTicketDto dto) throws SQLException, ClassNotFoundException {
