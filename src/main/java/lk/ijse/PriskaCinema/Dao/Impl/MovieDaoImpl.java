...
public class MovieDaoImpl {
    ...
    public static boolean save(ManageMoviesDto dto) throws SQLException, ClassNotFoundException {
   ...
   /* public static boolean saveMovieIdAssociate(ProducerDetailsDto producerDetailsDto) throws SQLException {
    ...
    public static List<ManageMoviesDto> loadAll() throws SQLException {
        Connection connection = DbConnection.getInstance().getConnection();
...
*/
    public static boolean update(ManageMoviesDto Dto) throws SQLException, ClassNotFoundException {
